...
<template>
    <header class="header container">
        ...
        <div class="header__user_menu">
            <router-link  to="/admin-panel" class="user_menu--login user_menu_link elemento_header">Administración</router-link>
            ...
            <span  @click="cerrarSesion()" class="user_menu--login user_menu_link elemento_header"><i><img src="../assets/img/user.svg" alt="icono de usuario"></i>CERRAR SESIÓN</span>
